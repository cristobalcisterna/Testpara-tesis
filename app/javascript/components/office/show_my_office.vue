<template>
    <section class="b-tooltips">
        <div class="box" style="margin-top: 60px; margin-left: 300px; margin-right: 300px">
            <h1>Detalle de mi dependencia</h1>
            <b-tabs type="is-boxed" position="is-centered">
                <b-tab-item label="Detalle de Dependencia">
                    <div class="center">
                        <h1>Información de la Dependencia</h1>
                    </div>
                    <div class="box">
                                ...
                                <div class="columns">
                                    <div class="column">
                                        <b-field label="Nombre dependencia:">
                                            <b-input v-model="office.name_office" type="text" readonly></b-input>
                                        </b-field>
                                    </div>
                                    <div class="column">
                                        <b-field label="Ubicación dependencia:">
                                            <b-input v-model="office.location" type="text" readonly></b-input>
                                        </b-field>
                                    </div>
                                </div>
                                ...
                                <div class="columns">
                                    <div class="column">
                                        <b-field label="Numero identificación dependencia:">
                                            <b-input v-model="office.identification_number_office" type="text"
                                                readonly></b-input>
                                    ...
                                    <div class="column">
                                        <b-field label="Identificación administración campus: ">
                                            <b-input v-model="office.campus_identification" type="text" readonly>
                                            </b-input>
                                        </b-field>
                                    </div>
                                ...
                                <div class="columns">
                                    ...
                                    <div class="column">
                                        <b-field label="Horas semanales disponibles: ">
                                            <b-input v-model="office.hours_available" type="text" readonly></b-input>
                                        </b-field>
                                    </div>
                                    <div class="column">
                                        <b-field label="Metros cuadrados: ">
                                            <b-input v-model="office.square_meter" type="text" readonly></b-input>
                                        </b-field>
                                    </div>
                                </div>
                                ...
                                <div class="columns">
                                    ...
                                    <div class="column">
                                        <b-field label="Edificio: ">
                                            <b-input v-model="office.building.name_building" type="text" readonly>
                                            </b-input>
                                        </b-field>
                                    </div>
                                </div>
                                <div class="columns">
                                    <div class="column">
                                        <b-field label="Descripción de dependencia: ">
                                            <b-input v-model="office.office_description" type="textarea" readonly>
                                            </b-input>
                                        </b-field>
                                    </div>
                                </div>
                ...
                <b-tab-item label="Bienes en la dependencia">
                    ...
                    <div class="center">
                        <h1>Bienes en la dependencia</h1>
                    </div>
                    <div class="column">
                        <b-table :data="goods" striped hoverable :paginated="true" per-page="8"
                            ...
                            <b-table-column field="identification_number_good" label="N° Inventario" sortable
                                searchable>
                                <template v-slot="props">
                            ...
                            <b-table-column field="duty_manager.name_duty_manager" label="Nombre persona asociada"
                                sortable searchable>
                                <template v-slot="props">
                            ...
                            <b-table-column field="amount" label="Monto" sortable searchable>
                                <template v-slot="props">
                                    {{ props.row.amount }}
                                </template>
                            </b-table-column>
        ...
        <a href="/duty_managers/myoffices" style="font-weight: normal;
    font-size: 20px;
    font-family: Arial;
    margin: 10px;
