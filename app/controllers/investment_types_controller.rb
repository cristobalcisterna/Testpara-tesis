class InvestmentTypesController < ApplicationController
  ...
  def show_null_investment_type
    @investment_types = InvestmentType.unscoped{InvestmentType.where(active_investment_type: 0)}
  end

  def show_active_investment_type
    @investment_types = InvestmentType.unscoped{InvestmentType.where(active_investment_type: 1)}
  end
  ...
  private
    ...
    def investment_type_params
      params.require(:investment_type).permit(:name_investment_type, :detail, :active_investment_type)
    end
end
