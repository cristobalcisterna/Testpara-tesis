...
class InvestmentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create investment_type" do
    assert_difference('InvestmentType.count') do
      post investment_types_url, params: { investment_type: { detail: @investment_type.detail, name_investment_type: @investment_type.name_investment_type } }
    end
  ...
  test "should update investment_type" do
    patch investment_type_url(@investment_type), params: { investment_type: { detail: @investment_type.detail, name_investment_type: @investment_type.name_investment_type } }
